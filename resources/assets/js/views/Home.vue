...
<!--             <section class="col-xs-12 col-sm-6 col-md-12 space-outside-up-sm">
                <h1>Search Results</h1>
                <h2 class="lead"><strong class="text-color-accent">1</strong> result was found for the search for <strong class="text-color-accent">Rome</strong></h2>      
                <div class="btn-group bg-main">
                  <button type="button" class="btn-standard bg-accent text-color-light text-hover-lighten transition-normal dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
